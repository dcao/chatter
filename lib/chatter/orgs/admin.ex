defmodule Chatter.Orgs.Admin do
  use Ecto.Schema
  ...
  @doc """
  We don't do any additional password verification since that's user hostile!
  """
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Chatter.Repo)
  ...
  """
  def valid_password?(%Chatter.Orgs.Admin{hashed_password: hashed_password}, password)
